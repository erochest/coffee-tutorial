(function() {
  ...
  Life = (function() {
    ...
    Life.prototype.run = function() {
      ...
      this.draw();
      this.gen += 1;
      return this.updateStatus("Generation: " + this.gen);
    };
    ...
    Life.prototype.update = function() {
      ...
      _results = [];
      for (i = 0, _ref = this.buffer.width; 0 <= _ref ? i <= _ref : i >= _ref; 0 <= _ref ? i++ : i--) {
        _results.push((function() {
          var _ref2, _results2;
          _results2 = [];
          for (j = 0, _ref2 = this.buffer.height; 0 <= _ref2 ? j <= _ref2 : j >= _ref2; 0 <= _ref2 ? j++ : j--) {
            if (this.next(i, j)) {
    ...
    Life.prototype.next = function(i, j) {
      var count, m, n, _ref, _ref2, _ref3, _ref4;
      count = 0;
      for (m = _ref = i - 1, _ref2 = i + 1; _ref <= _ref2 ? m <= _ref2 : m >= _ref2; _ref <= _ref2 ? m++ : m--) {
        for (n = _ref3 = j - 1, _ref4 = j + 1; _ref3 <= _ref4 ? n <= _ref4 : n >= _ref4; _ref3 <= _ref4 ? n++ : n--) {
          if ((0 <= m && m < this.buffer.width) && (0 <= n && n < this.buffer.height)) {
            count += 1;
          }
        }
      }
      switch (count) {
        case 2:
          return this.buffer.get(i, j, 0) === 255;
        case 3:
          return true;
        default:
          return false;
